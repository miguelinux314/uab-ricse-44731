...
\makeindex[columns=2,title={}] % Tells LaTeX to create the files required for indexing
\usepackage{hyperref}
...
%     brighter print colors
    \definecolor{color1}{RGB}{253,122,45} % Define the orange color used for highlighting throughout the book
    \definecolor{color2}{RGB}{10,110,150} % Define the orange color used for highlighting throughout the book
    \definecolor{color3}{RGB}{50,110,45} % Define the orange color used for highlighting throughout the book
    \definecolor{color4}{RGB}{253,112,35} % Define the orange color used for highlighting throughout the book
}
...
\usepackage{pgf-pie}
\usepackage{pgfplots}
\pgfplotsset{compat=1.18} % Ensure recent PGFPlots version
