...
%% Course aliases
\newcommand \source {\ensuremath{\mathcal{S}}\xspace}
\newcommand \othersource {\ensuremath{\mathcal{T}}\xspace}
\newcommand \alphabet {\ensuremath{\mathcal{A}}\xspace}
\newcommand \otheralphabet {\ensuremath{\mathcal{B}}\xspace}
\newcommand \entropy {\ensuremath{\mathcal{H}}}
\newcommand \Pri {\ensuremath{P(\sigma_i)}}
